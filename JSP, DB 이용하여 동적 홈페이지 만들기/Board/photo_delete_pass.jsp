...
<center><font size='5'><b>비밀번호 확인</b></font>                                                
...
<Form Action='photo_delete_input.jsp' Method='post'>                 
<input type='hidden' name='num' value='<%=num%>'>

<TABLE border='0' width='300' align='center'>
 	<TR>
         	<TD align='center'>
            		<font size=4><B>비밀번호</B></font>
	 	</TD>
	 	<TD>
...
<center><a href='photo_listboard.jsp'>[목록 보기]</a></center>      
