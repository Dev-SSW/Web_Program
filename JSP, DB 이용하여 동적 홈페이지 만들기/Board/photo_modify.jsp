...
<center><font size='5'><b> 게시판 글수정 </b></font>                  
...
<FORM Name='Modify' Action='photo_modify_output.jsp' Method='POST' OnSubmit='return Check()'>
...
<TABLE border='0' width='600'>
	...
	<TR>
		<TD width='100' bgcolor='cccccc'>
			<font size='3'><center><b>E-mail</b></center></font>
		</TD>
		<TD>
			<font size='3'><input type='text' size='40' maxlength='50' name='email' value="<%=email %>"></font>
		</TD>
	</TR>
	...
	<TR>
		...
		<TD>
			<font size='3'><input type='text' size='70' maxlength='50' name='title' value="<%=title %>"></font>
		</TD>
	</TR>
