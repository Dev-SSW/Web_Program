...
<%
// String realFolder = "";
String saveFolder = "c:/Users/sgg919/Desktop/3학년 1학기/(전) 웹프로그래밍2/Eclipse/Hellonew/WebContent/HomePage_Make/image";
...
String strSQL = "SELECT Max(num) FROM tblphoto";
...
strSQL ="INSERT INTO tblphoto (num, name, pass, email, title, contents, writedate, readcount, filename)";
...
response.sendRedirect("photo_listboard.jsp"); 
%>
