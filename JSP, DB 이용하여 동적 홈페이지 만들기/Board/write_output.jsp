	...
	<center>
		...
		<TABLE border='0' width='600'>
			<TR>
				...
				<TD align=right><font size='2'>작성일: <%=writedate%>, 조회수:
						<%=readcount%></font></TD>
			</TR>

			<TR>
				<TD align=left><font size='2'>파일이름 :<a
						href="file_down.jsp?num=<%=num%>"> <%=filename%></font></TD>
			</TR>
		</TABLE>
		...
		<TABLE border='0' width='600'>
			<TR>
				<TD align='left'><a href="modify_pass.jsp?num=<%=num%>">[수정하기]</a>
					<a href="delete_pass.jsp?num=<%=num%>">[삭제하기]</a></TD>

				<TD align='right'><a href="reply.jsp?num=<%=num%>">[답변하기]</a> <a
					href='write.jsp'>[글쓰기]</a> <a href='listboard.jsp'>[목록보기]</a></TD>
			</TR>
		</TABLE>
